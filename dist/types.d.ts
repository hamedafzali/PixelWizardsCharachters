...
export type EmotionName = 'neutral' | 'happy' | 'excited' | 'thinking' | 'encouraging' | 'sad' | 'surprised' | 'sleepy' | 'love' | 'confused' | 'proud' | 'shy';
...
export type Gesture = 'wave' | 'jump' | 'spin' | 'nod' | 'shake' | 'shrug' | 'point' | 'clap' | 'bounce';
...
export type BrowKey = 'idle' | 'happy' | 'excited' | 'thinking' | 'encouraging' | 'sad' | 'surprised' | 'sleepy' | 'confused' | 'proud' | 'shy';
 ...
 * actually swing.
 */
export type LayerName = 'shadow' | 'accBack' | 'tail' | 'farArm' | 'farLeg' | 'torso' | 'nearLeg' | 'nearArm' | 'earL' | 'earR' | 'head' | 'torsoFront' | 'accFront';
/**
 ...
 */
export declare const LAYER_ORDER: LayerName[];
