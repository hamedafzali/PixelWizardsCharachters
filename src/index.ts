...
export type {
  Easing, EasingName, ChannelName, ChannelSpec,
  NumericChannel, DiscreteChannel, InterpolationProfile,
} from './interpolate.js'
export { IdleMicroMotion, blinkStyle, BLINK_STYLES } from './micro.js'
export type { MicroConfig, MicroOutput, BlinkStyle } from './micro.js'
export {
  GESTURES, GESTURE_NAMES, GESTURE_DURING, planGesture,
  gestureLayers, gaitDrivenLayers, conflictsWithGait, locoTargetLayer,
} from './gestures.js'
...
export {
  LocomotionDriver, GAITS, LOCO_TARGETS, WALK_PHASES, FLY_PHASES, WING_FOLD_SX,
  samplePhase, wrapPhase, canDrive, drivesGait,
  type GaitName, type LocoTarget, type Gait, type PhaseKey,
} from './locomotion.js'
