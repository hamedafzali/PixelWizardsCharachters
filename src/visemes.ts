 ...
 */
export const VISEMES: Record<VisemeName, VisemeSpec> = {
...
const PMAP: Record<string, VisemeName> = {}
const put = (letters: string, v: VisemeName) => {
  for (const c of letters) PMAP[c] = v
}
put('اآأإٱ', 'aa')
put('هحع', 'e')
put('یيئ', 'i')
